...
public class MergeResult {
    ...
    protected ID id;
    protected List<ID> mergedRecordIds;
    protected boolean success;
    protected List<ID> updatedRelatedIds;
     ...
     * 
     */
    public List<ID> getMergedRecordIds() {
        if (mergedRecordIds == null) {
            mergedRecordIds = new ArrayList<ID>();
        }
     ...
     * 
     */
    public List<ID> getUpdatedRelatedIds() {
        if (updatedRelatedIds == null) {
            updatedRelatedIds = new ArrayList<ID>();
        }
