    ...
    extends Email
{
    ...
    protected List<ID> documentAttachments;
    @XmlElement(required = true, nillable = true)
     ...
     * 
     */
    public List<ID> getDocumentAttachments() {
        if (documentAttachments == null) {
            documentAttachments = new ArrayList<ID>();
        }
     ...
     *     
     */
    public void setOrgWideEmailAddressId(ID value) {
     ...
     *     
     */
    public void setTargetObjectId(ID value) {
     ...
     *     
     */
    public void setWhatId(ID value) {
        this.whatId = value;
    }
