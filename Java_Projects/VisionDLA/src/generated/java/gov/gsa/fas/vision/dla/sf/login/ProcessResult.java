...
public class ProcessResult {
    ...
    protected List<ID> newWorkitemIds;
     ...
     *     
     */
    public void setEntityId(ID value) {
        this.entityId = value;
    }
     ...
     *     
     */
    public void setInstanceId(ID value) {
    ...
    public List<ID> getNewWorkitemIds() {
        if (newWorkitemIds == null) {
            newWorkitemIds = new ArrayList<ID>();
        }
