 ...
 * 
 */
@WebServiceClient(name = "AttachmentWSImplService", targetNamespace = "http://fas.gsa.gov/services/Attachment/v1.0", wsdlLocation = "http://localhost:8080/attachment.services/AttachmentService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/attachment.services/AttachmentService?wsdl");
