...
public class WSClient {
	...
	public static void processfile(String filename) throws IOException, ServiceFault {
		...
		bindingProvider.getRequestContext().put(
				BindingProvider.USERNAME_PROPERTY, "p3xferdt");
		bindingProvider.getRequestContext().put(
				bindingProvider.PASSWORD_PROPERTY,
				"92mnGg1Cb14D9hVhG1W5fZra4UI=");
		 ...
		 * PasswordAuthentication("prem","amamd".toCharArray()); } };
		...
		System.out.println(bindingProvider.getRequestContext().get(
				BindingProvider.USERNAME_PROPERTY));
		attachment = new Attachment();
		attachment.setFilename("DoD_20141216_Computers.csv");
		// String filePath =
		// "C:/EDW/Nov-files-dateformat/20140901_20141031_20141119_FSS_EDW-pppifver-Standard-8-0-0-0-1.csv";
		String filePath = "C:/Myong/Myong.txt";
		//String filePath = "C:/EDW/DoD_20141216_Computers.csv";
		File afile = new File(filePath);
		DataHandler dh;
		dh = new DataHandler(afile.toURI().toURL());
