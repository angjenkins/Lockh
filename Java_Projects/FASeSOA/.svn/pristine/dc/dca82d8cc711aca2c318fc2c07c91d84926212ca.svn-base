 ...
 * @author CourtAZabel
 */
public class ZkpBas_RecordMapperTest extends AbstractRecordMapperTest {

	public ZkpBas_RecordMapperTest(){
		super();
		this.wdcOrderPartDao = this.wdcOrderPartDaoFactory.createWdcOrderPartDao_ZkpBas();
		this.recordMapper = new ZkpBasRecordMapper();
		this.recordParser = (new ZkpBasRecordParserFactory()).getRecordParser();
	}
