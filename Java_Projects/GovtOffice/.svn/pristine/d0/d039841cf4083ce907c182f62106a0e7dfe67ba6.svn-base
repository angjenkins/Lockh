...
public class OutputMessagesTypeExists {
    ...
    public OutputMessagesTypeExists() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OutputMessagesTypeExists)) return false;
        OutputMessagesTypeExists other = (OutputMessagesTypeExists) obj;
