...
import com.fpds.service.ExistsGovernmentOfficeResponseType;
...
/*	public static com.fpds.service.ExistsGovernmentOfficeResponseType exist(
		...
		ExistsGovernmentOfficeResponseType eg = new ExistsGovernmentOfficeResponseType();
		...
		com.fpds.service.ExistsGovernmentOfficeResponseType response = new com.fpds.service.ExistsGovernmentOfficeResponseType();
		try {
			com.fpdsng.www.FPDS.ExistsGovernmentOfficeResponseType result = ws.getGovernmentOfficePort().exists(ua, gs);
...
*/	public static  UserAuthenticationKeyType setuserpass(com.fpds.service.UserAuthenticationKeyType uapass) {
	...
	private static void populatedataforget(GetGovernmentOfficeResponseType ggor,
	...
	private static void populategovtofficetype(
		...
		if (ggor.getGovernmentOffice() == null) {
			...
			governmentOffice.setStreetAddress(ggor.getGovernmentOffice()
					.getStreetAddress());

			/*
			 * response.getGovernmentOffice().setStreetAddress(
			 * ggor.getGovernmentOffice
			 * ().getStreetAddress()==null?"":ggor.getGovernmentOffice
			 * ().getStreetAddress());
			 */
			governmentOffice.setStreetAddress2(ggor.getGovernmentOffice()
					.getStreetAddress2());
			governmentOffice.setStreetAddress3(ggor.getGovernmentOffice()
					.getStreetAddress3());
			governmentOffice.setCity(ggor.getGovernmentOffice().getCity());
			governmentOffice.setState(ggor.getGovernmentOffice().getState());
			governmentOffice.setProvince(ggor.getGovernmentOffice()
					.getProvince());
			governmentOffice
					.setZIPCode(ggor.getGovernmentOffice().getZIPCode());
			governmentOffice.setCountryCode(ggor.getGovernmentOffice()
					.getCountryCode());
			governmentOffice.setGovernmentOfficeID(ggor.getGovernmentOffice()
					.getGovernmentOfficeID());
			governmentOffice.setOfficeID(ggor.getGovernmentOffice()
					.getOfficeID());
			governmentOffice.setAgencyID(ggor.getGovernmentOffice()
					.getAgencyID());
			governmentOffice.setOfficeName(ggor.getGovernmentOffice()
					.getOfficeName());
			governmentOffice.setAgencyName(ggor.getGovernmentOffice()
					.getAgencyName());
			governmentOffice.setRegionCode(ggor.getGovernmentOffice()
					.getRegionCode());
			governmentOffice.setParentOrganizationID(ggor.getGovernmentOffice()
					.getParentOrganizationID());
			governmentOffice.setParentOrganizationCode(ggor
					.getGovernmentOffice().getParentOrganizationCode());
			governmentOffice.setIsContractingOffice(ggor.getGovernmentOffice()
					.getIsContractingOffice());
			governmentOffice.setContractingOfficeID(ggor.getGovernmentOffice()
					.getContractingOfficeID());
			governmentOffice.setContractingOfficeStartDate(ggor
					.getGovernmentOffice().getContractingOfficeStartDate());
			governmentOffice.setContractingOfficeEndDate(ggor
					.getGovernmentOffice().getContractingOfficeEndDate());
			governmentOffice.setStartDate(ggor.getGovernmentOffice()
					.getStartDate());
			governmentOffice
					.setEndDate(ggor.getGovernmentOffice().getEndDate());

			AuditInformationType ait = new AuditInformationType();
			ait.setCreatedBy(ggor.getGovernmentOffice().getAuditInformation()
					.getCreatedBy());

			ait.setCreatedDate(ggor.getGovernmentOffice().getAuditInformation()
					.getCreatedDate());

			ait.setLastModifiedBy(ggor.getGovernmentOffice()
					.getAuditInformation().getLastModifiedBy());
			ait.setLastModifiedDate(ggor.getGovernmentOffice()
					.getAuditInformation().getLastModifiedDate());
