...
public class ParameterTypeExists  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ParameterTypeExists)) return false;
        ParameterTypeExists other = (ParameterTypeExists) obj;
