...
@XmlType(name="OutputMessagesType",namespace="http://www.getlist.com")
public class OutputMessagesType {
    private com.fpds.getlist.ErrorType[] listOfErrors;

    private com.fpds.getlist.WarningType[] listOfWarnings;

    private com.fpds.getlist.InfoType[] listOfInfoMessages;

    public OutputMessagesType() {
    }

    public OutputMessagesType(
           com.fpds.getlist.ErrorType[] listOfErrors,
           com.fpds.getlist.WarningType[] listOfWarnings,
           com.fpds.getlist.InfoType[] listOfInfoMessages) {
     ...
     * @return listOfErrors
     */
    public com.fpds.getlist.ErrorType[] getListOfErrors() {
        return listOfErrors;
    }
     ...
     * @param listOfErrors
     */
    public void setListOfErrors(com.fpds.getlist.ErrorType[] listOfErrors) {
        this.listOfErrors = listOfErrors;
    }
     ...
     */
    public com.fpds.getlist.WarningType[] getListOfWarnings() {
        return listOfWarnings;
    }
     ...
     */
    public void setListOfWarnings(com.fpds.getlist.WarningType[] listOfWarnings) {
        this.listOfWarnings = listOfWarnings;
    }
     ...
     */
    public com.fpds.getlist.InfoType[] getListOfInfoMessages() {
        return listOfInfoMessages;
    }
     ...
     */
    public void setListOfInfoMessages(com.fpds.getlist.InfoType[] listOfInfoMessages) {
        this.listOfInfoMessages = listOfInfoMessages;
    }
