...
<a id="exportLink" href="./SimpleHTML?portfolio={{portfolio}}&antiCSRF={{acsrf}}&session_id={{session_id}}" target="_blank">Export_HTML</a>
<img src="theme/img/icn_export.png" alt="PricesPaid" height="20px;">
</span>
<span id="exportButton-XLS">
<a id="exportLink-XLS" href="./SimpleCSV?portfolio={{portfolio}}&antiCSRF={{acsrf}}&session_id={{session_id}}" target="_blank">Export_EXCEL</a>
<img src="theme/img/icn_export.png" alt="PricesPaid" height="20px;">
</span>
