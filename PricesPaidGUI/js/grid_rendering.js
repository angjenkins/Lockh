...
function grid_rendering() {
   ...
   sortByColumn(transactionData,currentColumn,currentOrderIsAscending);
    ...
    //console.log('grid_rendering before=' + JSON.stringify(transactionData))
    
    transactionData.forEach(function (e, i, a) {
    	    var found = $.inArray(e["dataSource"],colors);
    ...
    //console.log("allcolors" + JSON.stringify(colors))
    
    //console.log("standardColors" + JSON.stringify(standardColors))
...
// field...
        e.color = standardColors[$.inArray(e["dataSource"],colors)]
	//var found = $.inArray(e["dataSource"],e);
	//console.log('found = ' + found)
	//e.color = colors[found]
        //e.color = standardColors[Math.abs(Hashcode.value(e["dataSource"])) % NUM_STANDARD_COLORS];
        
        data[i] = obj;
    });
    //console.log('grid_rendering after=' + JSON.stringify(transactionData))
    ...
    $(function () {
	$('#myGrid').innerHTML = "";
	grid = new Slick.Grid("#myGrid", format_transactionData(transactionData), columns, options);
	...
	grid.onSort.subscribe(function (e, args) {
	    ...
	    grid.setData(format_transactionData(transactionData));
