...
<link rel="stylesheet" type="text/css" href="./theme/upload-assets/libs/bs/css/bootstrap.css">
<link rel="stylesheet" type="text/css" href="./theme/upload-assets/libs/fa-4.3/css/font-awesome.css">
...
<script src="./theme/upload-assets/js/respond.min.js"></script>

<!-- CAP OS CORE CSS
+++++++++++++++++++++++++++++++++++++++++++++++++-->
<link rel="stylesheet" type="text/css" href="./theme/upload-assets/css/cap-os.css">
<!--==================================================
					ANGULAR JS
================================================== -->
...
<h1><span class="fa fa-cloud-upload"></span><br />INGEST</h1>
</header>
...
<!-- ERROR ALERT -->
<div class="alert alert-danger alert-dismissible" role="alert" id="failure" style="display:none">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>There was an error processing your file.</div>
<!-- SUCCESS ALERT -->
<div class="alert alert-success alert-dismissible" role="alert" id="success" style="display:none">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> Your file uploaded successfully.</div>
</div>
</section>

<!--================ FORM ==============================--> 
<div id="r_content-main"><div class="container"> 
<form action="FileUploadService" method="post" name="fileform" id="targetform"  enctype="multipart/form-data">
<!--
...
<!--<small>The preferred format is <span class="fa fa-file-word-o"></span> MS Word (.doc, or .docx). For convience, you may also include <span class="fa fa-file-pdf-o"></span> PDF format.</small>-->
							<!--</h4>-->
						<h4><span class="label label-warning"></span> Choose your file <!--<small>The preferred format is <span class="fa fa-file-word-o"></span> MS Word (.doc, or .docx). For convience, you may also include <span class="fa fa-file-pdf-o"></span> PDF format.</small>--></h4>
						<h4 style="margin-left:15PX;"><small>To begin, please use the browse button to locate the file you wish to upload. <br>
To complete the process, use the upload button.</small></h4>
						<div class="clearfix">&nbsp;</div>
					</div>			
...
-->
<div id="uploadmessage" style="color:red;display:none"><h1>File Uploading...Please wait...</h1></div>
<br>		
<!-- FILE UPLOAD -->	
...
<div class="col-xs-12 col-sm-12">
	...
	<label for="file" class="sr-only">File input</label>
      <input type="file" class="form-control" id="file-3a" name="File Upload"  />
...
<script src="./theme/upload-assets/libs/jquery-2.1.1.min.js"></script> 
<noscript>
</noscript>
<script src="./theme/upload-assets/libs/bs/js/bootstrap.min.js"></script> 
<noscript>
</noscript>

<!-- MODERENIZER 2.8.3 
+++++++++++++++++++++++++++++++++++++++++++++++++--> 
<script src="./theme/upload-assets/libs/modernizr.2.8.3.js"></script>
<noscript>
</noscript>
<script src="./theme/upload-assets/js/classie.js"></script>
<noscript>
</noscript>


<!-- FILE INPUT --> 
<script src="./theme/upload-assets/js/fileinput.js"></script>
<noscript>
</noscript>
...
<script>
	...
	//xhr.ontimeout = function() {alert("Browser timeout = " + network.http.response.timeout)}
